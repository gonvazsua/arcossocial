...
router.post('/', (req, res) => {
    beneficiaryService
        .createBeneficiary(req.body._id, req.body.fullName, req.body.dni, req.body.address, req.body.entity, req.body.valuationCard, req.body.valuationDate, req.body.creationDate, req.body.mate, req.body.familySize, req.body.isActive)
